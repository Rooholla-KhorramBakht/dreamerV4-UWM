...
from dreamerv4.loss import FlowMatchingForwardProcess, RMSLossScaler, compute_flowmatching_loss
...
def train_epoch(
    ...
    for step_idx, batch in enumerate(train_loader):
        ...
        with torch.autocast(device_type="cuda", dtype=torch.bfloat16):
            ...
            loss_micro = (
                loss_scaler("obs_loss", obs_flow_loss.mean())
                + loss_scaler("act_loss", act_flow_loss.mean())
